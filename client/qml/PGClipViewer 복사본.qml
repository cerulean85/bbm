...
PGPage
{
    ...
    property string linkUrl: opt.ds ? "" : R.startsWithAndReplace(md.clipDetail.linkUrl, "https", "http")
...
//                else evtBack();
    ...
    Timer
    {
        ...
        repeat: false
        interval: 200
        onTriggered: backBehaviroForAndroid();
    }
...
//                R.log("Where: PGClipViewer.qml >> noCourse < 1 || noClip < 1");
            ...
            if(cmd.isOnline() === 2)
            {
                ...
                ap.setYMethod(mainView, "onContent");
            }
    ...
    width: opt.ds ? R.dp(1242) : R.viewWidth()
    height: opt.ds ? R.dp(2208) : R.viewHeight()
    ...
    Rectangle
    {
        ...
        Rectangle
        {
            ...
            Row
            {
                ...
                CPText
                {
                    text: opt.ds ? "30" : md.clipDetail.repleCount
                    font.pointSize: R.pt(45)
                    color: R.color_bgColor001
                }
            }
...
//                    showContent(true, true);
    ...
    CPFlickMoreIndicator
    {
        ...
        condRun: ENums.WORKING_CLIPCOMMENT
        condStop: ENums.FINISHED_CLIPCOMMENT

        anchors.bottom: commentInputController.top
    }
            ...
            Timer
            {
                ...
                onTriggered:
                {
                    ...
                    if(!showedCommentWindow)
                    {
                        ...
                        showWindow(ENums.WINDOW_COMMENT, true);
                        showWindow(ENums.WINDOW_QUIZ, false);

                        showController(ENums.CONTROLLER_WINDOW, false);
                        showController(ENums.CONTROLLER_COMMENT_INPUT, true);
                    }
    ...
    PropertyAnimation
    {
        ...
        property: "y";
        to: R.dp(615) - mainView.heightBottomArea
        duration: 300
    }
...
//                videoPlayer.pause();
    ...
    Timer
    {
        running: opt.ds ? false : !md.logining
        repeat: false
        interval: 200
        onTriggered:
        {
            if(linkUrl === "") return;
            else showContent(true, false);
        }
    }
    ...
    Timer
    {
        ...
        onTriggered:
        {
            ...
            ap.setYMethod(mainView, "evtBack");
        }
    }
}
