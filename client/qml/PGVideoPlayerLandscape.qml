...
Rectangle {
    ...
    property int appWindowWidth: md.fullScreen ? appWindow.height : appWindow.width
    property int appWindowHeight: md.fullScreen ? appWindow.width : appWindow.height
    ...
    property int screenHeight: appWindowWidth * (md.fullScreen ? 1 : 0.5625)
    property int screenWidth: md.fullScreen ? (appWindowHeight + heightStatusBar) : appWindowWidth
