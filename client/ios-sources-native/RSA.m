...
static NSString* _pbKey = @"";
static NSString* _pvKey = @"";
+ (NSString*) pbKey { return _pbKey; }
+ (void) setPbKey:(NSString*)key { _pbKey = key; }

+ (NSString*) pvKey { return _pvKey; }
+ (void) setPvKey:(NSString*)key { _pvKey = key; }
